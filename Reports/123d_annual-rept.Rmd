...
knitr::include_graphics(path = "/Users/christophermichaud/Documents/Projects/udwr-mfo_data-mgt/Reports/Assets/walleye-carlos.jpg",
                        dpi = 75)
```
</center>  
...
knitr::include_graphics(path = "/Users/christophermichaud/Documents/Projects/udwr-mfo_data-mgt/Reports/Assets/smallmouth-nick.jpg",
                        dpi = 200)
```
</center>
...
cpue_rch$LCO %>% 
  ...
  add_footer_lines(values = paste("Based on ", 
                                  ...
                                  " hours of electrofishing effort"), 
                   top = FALSE) %>%
  add_header_lines(values = paste("Table 7. Nonnative fish encounters within the \nLower Westwater Reach,", yr), 
                   top = TRUE) %>% 
    bold(part = "header") %>% 
  fontsize(i = 1, size = 14, part = "header") %>% 
  align(j = 1, align = "left", part = "all")
...
cpue_rch$LCO %>% 
  ...
  add_footer_lines(values = paste("Based on ", 
                                  ...
                                  " hours of electrofishing effort"), 
                   top = FALSE) %>% 
  add_header_lines(values = paste("Table 8. Native fish encounters within the \nLower Westwater Reach,", yr), 
                   top = TRUE) %>% 
    bold(part = "header") %>% 
  fontsize(i = 1, size = 14, part = "header") %>% 
  align(j = 1, align = "left", part = "all")
...
tibble(yr = c("2021", "2020", "2019", "2018", "2017"),
  ...
  add_header_lines(values = paste("Table 9. Smallmouth bass catch-per-unit-effort \nLower Westwater Reach, 2017 -", yr), 
                   top = TRUE) %>% 
    bold(part = "header") %>% 
  fontsize(i = 1, size = 14, part = "header") %>% 
  align(j = 1, align = "left", part = "all")
...
<center>
```{r cpue-ls-fig, fig.cap=cap4, eval=FALSE}
cpue_ls
